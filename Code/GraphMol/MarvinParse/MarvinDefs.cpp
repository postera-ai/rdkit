...
void MarvinSuperatomSgroupExpanded::parseMoleculeSpecific(
  ...
  sgroup->setProp(internKey("LABEL"), this->title);
}
void MarvinMultipleSgroup::parseMoleculeSpecific(
  ...
  sgroup->setProp(internKey("MULT"), this->title);
}
void MarvinSruCoModSgroup::parseMoleculeSpecific(
  ...
  sgroup->setProp(internKey("CONNECT"), this->connect);
...
void MarvinDataSgroup::parseMoleculeSpecific(
  ...
  sgroup->setProp(internKey("FIELDNAME"), this->fieldName);

  if (this->queryType != "") {
    sgroup->setProp(internKey("QUERYTYPE"), this->queryType);
  }
  if (this->queryOp != "") {
    sgroup->setProp(internKey("QUERYOP"), this->queryOp);
  }
  ...
  sgroup->setProp(internKey("FIELDDISP"), out.str());  // really not used by RDKIT

  std::vector<std::string> fieldDatas;
  fieldDatas.push_back(this->fieldData);
  sgroup->setProp(internKey("DATAFIELDS"), fieldDatas);

  // The following props are not part of the RDKit structure for MOL
  // files, but we save them so that we can round-trip the MRV

  sgroup->setProp(internKey("UNITS"), this->units);
  sgroup->setProp(internKey("UNITSDISPLAYED"), this->unitsDisplayed);
  sgroup->setProp(internKey("CONTEXT"), this->context);
  sgroup->setProp(internKey("PLACEMENT"), this->placement);
  sgroup->setProp(internKey("X"), this->x);
  sgroup->setProp(internKey("Y"), this->y);
}
