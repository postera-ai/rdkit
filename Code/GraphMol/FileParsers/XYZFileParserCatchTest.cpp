...
TEST_CASE("xyz file parser") {
  SECTION("basics") {
    ...
    CHECK(mol->hasProp(internKey("_FileComments")));
    CHECK(mol->getProp<std::string>(internKey("_FileComments")) == "charge=-1=");
...
TEST_CASE("xyz block parser") {
  SECTION("basics") {
    ...
    CHECK(mol->hasProp(internKey("_FileComments")));
    CHECK(mol->getProp<std::string>(internKey("_FileComments")) == "        methane");
