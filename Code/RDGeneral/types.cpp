...
const std::uint16_t computedPropNameKey = 47;
}
...
const std::uint16_t NullBondKey = 8;
...
const std::uint16_t _CIPCodeKey = 13;
const std::string _CIPRank = "_CIPRank";
const std::uint16_t _CIPRankKey = 14;
const std::string _ChiralityPossible = "_ChiralityPossible";
const std::uint16_t _ChiralityPossibleKey = 15;
...
const std::uint16_t _MolFileRLabelKey = 29;
const std::string _MolFileAtomQuery = "_MolFileAtomQuery";
const std::uint16_t _MolFileAtomQueryKey = 21;
const std::string _MolFileBondQuery = "_MolFileBondQuery";
const std::uint16_t _MolFileBondQueryKey = 25;
...
const std::string _canonicalRankingNumbers = "_canonicalRankingNumbers";
const std::uint16_t _canonicalRankingNumbersKey = 49;
const std::string _doIsoSmiles = "_doIsoSmiles";
const std::uint16_t _doIsoSmilesKey = 58;
...
const std::uint16_t _supplementalSmilesLabelKey = 74;
...
const std::uint16_t _unspecifiedOrderKey = 77;
const std::string _brokenChirality = "_brokenChirality";
const std::uint16_t _brokenChiralityKey = 48;
...
const std::uint16_t dummyLabelKey = 81;
...
const std::uint16_t molAtomMapNumberKey = 86;
...
const std::uint16_t molInversionFlagKey = 92;
const std::string molParity = "molParity";
const std::uint16_t molParityKey = 94;
...
const std::uint16_t smilesSymbolKey = 108;
