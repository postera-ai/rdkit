...
inline constexpr std::string_view kWellKnownKeys[] = {
    ...
    "_ZBO_H",
    "__molzip_used",
    "__molzip_bond_stereo",
    "__molzip_chiral_mark",
    "DEPROTECTIONS",
    "DEPROTECTION_COUNT",
    "_TriposAtomName",
    "_TriposChargeType",
    ...
    "CDX_PRODUCT_ID",
    "CDX_AGENT_ID",
    "shape_align_shape_tanimoto",
    "shape_align_color_tanimoto",
    "molNum",
    "idx",
    "was_dummy",
    "keep",
    ...
    "_headCrossings",
    "_qatomHasStereoSet",
    "_conjugatedOrAromatic",
    "_replaceCoreDummyBond",
    "_newBondOrder",
    "_molfragSaveStereo",
    "__zipIndex",
    "__formerIdx",
